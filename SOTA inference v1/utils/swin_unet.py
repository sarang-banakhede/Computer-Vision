"""
Description: This file contains the implementation of the Swin Transformer model.
"""
import torch
...
class SwinTransformerSys(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=4, in_chans=3, num_classes=1,
        ...
        if self.final_upsample == "expand_first":
            ...
            self.output = nn.Sequential(nn.Conv2d(in_channels=embed_dim, out_channels=self.num_classes, kernel_size=1, bias=False),
                                        nn.Sigmoid())
...
def main():
    ...
    weight_path = config['Weights']['swin_unet']
